                    ...
                    <div className={'col-md-9 col-sm-12 col-xs-12'}>
                            ...
                            <div className={'col-md-9 font-tarsus align-self-center text-justify'} style={{paddingLeft:'1em', fontSize:'1.1em'}} >
                               <strong>React Native Intern</strong><br/>
                                ...
                                I interned as a React Native developer in the organisation. I worked on building cross platform applications using React Native.
                                 Since the technology was new to me, it provided a great working and learning experience. I worked in a team, and was consistently guided by my supervisor to overcome
                                my shortcomings.
                                ...
                                <hr/>
                                I interned as a Software developer in the organisation. I worked on building a desktop application for the organisation for the purpose of canteen management.
                                I planned and developed the complete application on my own with some feedback from my colleagues and help from my seniors. I developed the application using JavaFx.
                        ...
                        <div className={'row'}>
                            ...
                            <div className={'col-md-9 font-tarsus align-self-center text-justify'} style={{paddingLeft:'1em', fontSize:'1.1em'}}>
                                ...
                                <hr/>
                                In these three years of college, I have learnt a lot and have worked on various projects. I have worked on Software Development, Mobile Application Development,
                                 Web Development, Cloud Technology and Blockchain Technology. I have participated in several events. I received the first position in Spell Bee Competition which was
                                 held in Innovate 2K15. My CGPA is 8.43 (till 5<sup>th</sup> semester)
                            </div>
                        </div>
                    </div>
